module.exports = {
    ...
    'Check the home page': browser => {
        ...
        .waitForElementPresent('body')
            ...
            .verify.containsText('div[id="welcomeScreen"]', 'Enter Wanted')
            .verify.containsText('div[id="welcomeScreen"]', 'Modify Wanted')
            .verify.containsText('div[id="welcomeScreen"]', 'Cancel Wanted')
